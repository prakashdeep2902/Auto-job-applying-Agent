...
def login_LN() -> None:
    ...
    * If both failed, asks user to login manually
    ...
    pytime.sleep(5)
    print_lg("Current URL:", driver.current_url)
    print_lg("Page title:", driver.title)
    ...
    try:
        ...
        try:
            ...
            print_lg(e),
            print_lg(driver.page_source[:5000])
        try:
            ...
            while current_count < switch_number:
                ...
                for job in job_listings:
                    ...
                    if not is_easy_apply:
                        try:
                            apply_link_el = driver.find_element(
                                By.XPATH,
                            ...
                            if apply_link_el:
                                ...
                                is_easy_apply = True
                                print_lg(
                                    "Detected Easy Apply via URL pattern (openSDUIApplyFlow)"
                                )
                        except:
                            pass
                        ...
                        try:
                            ...
                            if apply_btn:
                                ...
                                if tabs_after > tabs_before:
                                    ...
                                    if (
                                        close_tabs
                                        and driver.current_window_handle != linkedIn_tab
                                    ):
                                        driver.close()
                                    driver.switch_to.window(linkedIn_tab)
                                    print_lg(
                                        "External apply detected via new tab, skipping"
                                    )
                                else:
                                    try:
                                        ...
                                        is_easy_apply = True
                                        print_lg(
                                            "Detected Easy Apply via modal appearance after click"
                                        )
                                    except:
